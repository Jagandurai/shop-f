...
const Booknow = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#fff7fb_0%,#fff2f8_100%)] px-3 py-6 sm:px-5  md:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-[1180px]">
        <div className="mx-auto flex max-w-[860px] flex-col items-center rounded-[30px] border border-white/70 bg-white/80 px-5 py-8 text-center shadow-[0_18px_42px_rgba(123,31,162,0.10)] backdrop-blur-sm sm:px-6 sm:py-10 md:px-10 md:py-12">
          <span className="inline-flex items-center mb-3 justify-center rounded-full border border-[#efd9f5] bg-[#fbf2ff] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#8b2398]  sm:text-sm">
